"""Selected regular-axis outer branch of g, and a C_s=0 flux diagnostic.
...
1. UNDER-DETERMINACY OF THE g-ODE.  (5/4) f' g - (1/2) f g' = 2^{-1/2},
   ...
   Selecting the analytic regular-axis outer branch removes the x^{5/2} term:
...
2. ROW-1 FLUX EXPONENT AND ITS CANCELLATION. On the selected C_s=0 truncated
   ...
   next: with the selected g above, INT t1 F11 r dtheta ~ r^2 (checked at
